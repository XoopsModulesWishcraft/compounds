 ...
 * @package kernel
 */
class CompoundsLanguage extends XoopsObject
{

    function CompoundsLanguage($id = null)
    {
...
* @package kernel
*/
class CompoundsLanguageHandler extends XoopsPersistableObjectHandler
{							
 
    function __construct(&$db) 
    {
		$this->db = $db;
        parent::__construct($db, "compounds_language", 'CompoundsLanguage', "id", "language");
    }
