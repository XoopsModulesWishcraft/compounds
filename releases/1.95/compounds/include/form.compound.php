<?php
	...
	function formCompound($compound_id) {
		...
		$hyposise_editor = !isset($_REQUEST['hyposise_editor'])?'xinha':$_REQUEST['hyposise_editor'];
		$process_editor = !isset($_REQUEST['process_editor'])?'xinha':$_REQUEST['process_editor'];
		$synopisise_editor = !isset($_REQUEST['synopisise_editor'])?'xinha':$_REQUEST['synopisise_editor'];
		...
		$cform->addElement(new XoopsFormHidden('fct', $_REQUEST['op']));
