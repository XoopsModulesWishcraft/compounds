...
class CompoundsFormCompound extends XoopsFormElement
{
    ...
    function render()
    {
		...
		if (!$this->_compound_id||!is_object($compound)) {
			...
			$ret  = "Alias:&nbsp;&nbsp;&nbsp;<input type='text' name='" . $this->getName() . "[alias]' id='" . $this->getName() . "[alias]' size='42' maxlength='255' value='" . $compound->getVar('alias') . "' /><br/>&nbsp;Model:<br/><p style=\"position:relative; left: 29px; width:390px;\">";
